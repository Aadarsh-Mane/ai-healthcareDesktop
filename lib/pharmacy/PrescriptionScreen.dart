...
class _PrescriptionToSaleScreenState extends State<PrescriptionToSaleScreen> {
  ...
  Future<void> _fetchPrescriptions() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5001/pharma/getAllPrescriptions'),
      );
  ...
  Future<void> _fetchInventory({
    ...
    try {
      ...
      final uri = Uri.parse('http://localhost:5001/pharma/getInventory')
  ...
  Future<void> _createSale() async {
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'http://localhost:5001/pharma/createSaleFromPatientPrescription'),
